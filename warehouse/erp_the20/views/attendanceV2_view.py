...
#         tags=["Attendance V2"],
#         summary="Xem chi tiết đăng ký ca theo ID",
#         parameters=[
#             OpenApiParameter(
#                 name="id",
...
#         ],
#         responses={
#             200: AttendanceSummaryV2ReadSerializer,
...
#     """
#     RESTful endpoints:
#       - GET    /attendanceV2/summary-v2/{id}
...
#         obj = get_object_or_404(AttendanceSummaryV2, id=pk)
