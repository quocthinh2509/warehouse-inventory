...
#     ("cancelled", "Cancelled"),
#     ]
#     employee = models.In(Employee, on_delete=models.PROTECT) # nhân viên được gán ca
...
class AttendanceCorrection(TimeStampedModel):
    ...
    #approver = models.ForeignKey("auth.User", null=True, blank=True, related_name="+", on_delete=models.SET_NULL) 
...
class LeaveRequest(TimeStampedModel): 
    ...
    #approver = models.ForeignKey("auth.User", null=True, blank=True, on_delete=models.SET_NULL) 
